...
def main():
    ...
    with sqlite3.connect(sys.argv[1]) as con:
        ...
        for item in tqdm.tqdm(items):
            download(cur, f'https://nonfungible.com/_next/image?url=http://images1.nonfungible.com:3333/api/v4/asset/media/image/{item["project"]}/{item["nftTicker"]}/{item["assetId"]}&w=32&q=100')
